...
GROUP_Config = {
    ...
    "netRangeIPv6": {
        "type": "network_range",
        "attribute": "fd42:9ad6:a276:908a:216:3eff::/96",
    },
}
...
def inventory():
    ...
    # Test Values
    inv.data = inv.load_yaml_data(
        "tests/unit/plugins/inventory/fixtures/incus_inventory.atd"
    )  # Load Test Data

...
options:
  incus_instance:
    ...
    type: string
    vars:
      - name: sbstp_incus_host
      - name: sbstp_incus_instance
  incus_user:
    description:
  ...
  incus_file_transfer_method:
    ...
    choices:
      ...
      - temp
    vars:
      - name: sbstp_incus_file_transfer_method
"""
...
class Connection(SSHConnection):
    ...
    transport = "sbstp.incus.ssh_incus"
    has_pipelining = True
